...
import com.example.HOT.nomichats.Conversation;
import com.example.HOT.nomichats.R;
...
public class ChatFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Conversation,ConvViewHolder> friendsConvAdapter=new FirebaseRecyclerAdapter<Conversation, ConvViewHolder>(
            ...
            protected void populateViewHolder(final ConvViewHolder convViewHolder,
                                              final Conversation conv, int position) {
